...
/*   Updated: 2022/04/23 13:10:45 by hrings           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	do_moves(t_push_swap *push_swap, t_moves *moves)
{
	...
	index = 0;
	while (index++ < moves->ra)
		ra(push_swap);
	index = 0;
	while (index++ < moves->rb)
		rb(push_swap);
	index = 0;
	while (index++ < moves->rr)
		rr(push_swap);
	index = 0;
	while (index++ < moves->rra)
		rra(push_swap);
	index = 0;
	while (index++ < moves->rrb)
		rrb(push_swap);
	index = 0;
	while (index++ < moves->rrr)
		rrr(push_swap);
	pa(push_swap);
}
